<%-- 
    ...
    Created on : Mar 16, 2021, 10:03:46 PM
    Author     : QuocBao
--%>
            ...
            <section class="bg-light">
                <div class="container pb-5">
                    ...
                    <div class="col-lg-7 mt-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h1 class="h2">${p.productName}</h1>
                                <p class="h3 py-2">${p.productPrice} VND</p>
                                <p class="py-2">
                                    ...
                                    <span class="list-inline-item text-dark">Rating 4.4</span>
                                </p>
                        ...
                        <div class="p-2 pb-3">
                            ...
                            <div class="product-wap card rounded-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-center mb-0">${o.productPrice}</p>
                                </div>
                            </div>
