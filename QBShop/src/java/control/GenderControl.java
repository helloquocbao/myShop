 ...
 * @author QuocBao
 */
@WebServlet(name = "GenderControl", urlPatterns = {"/gender"})
public class GenderControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GenderControl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
